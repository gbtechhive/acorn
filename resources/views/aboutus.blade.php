...
<body>
    ...
    <div id="acron-container">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p id="ac-para">ACORN is a multispecialty clinical research organization working in the areas of medical and dental diseases</p>
            </div>
        </div>
    </div>
    </div>
